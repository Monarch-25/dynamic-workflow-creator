# dynamic_graph_smoke (1.0.0)

## Capability
Analyze a python repo: find references, extract key snippets, summarize findings, and provide final recommendation.

## Subtasks
- `task_1`: Analyze a python repo: find references, extract key snippets, summarize findings, and provide final recommendation (tool: `tool_task_1`)
