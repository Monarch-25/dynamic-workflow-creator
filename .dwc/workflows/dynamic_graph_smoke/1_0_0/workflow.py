...
Workflow: dynamic_graph_smoke (1.0.0)
"""
...
WORKFLOW_NAME = "dynamic_graph_smoke"
WORKFLOW_DESCRIPTION = "Analyze a python repo: find references, extract key snippets, summarize findings, and provide final recommendation."
SUBTASKS: List[Dict[str, str]] = [
  {
    "description": "Analyze a python repo: find references, extract key snippets, summarize findings, and provide final recommendation",
    "id": "task_1",
...
STEP_DEFS: List[Dict[str, Any]] = [
  ...
  {
    "config": {
      "subtask_description": "Analyze a python repo: find references, extract key snippets, summarize findings, and provide final recommendation",
      "tool_name": "tool_task_1"
    },
    "id": "task_1",
    "retry_policy": {
