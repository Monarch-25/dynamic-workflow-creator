...
## Subtasks
- `task_1`: Create a workflow that runs a safe shell command only with explicit user confirmation and can be modified by user instruction (tool: `tool_task_1`)
