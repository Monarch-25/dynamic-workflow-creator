# dynamic_graph_multi (1.0.0)

## Capability
First search python functions then summarize results then produce final concise answer.

## Subtasks
- `task_1`: First search python functions (tool: `tool_task_1`)
- `task_2`: summarize results (tool: `tool_task_2`)
- `task_3`: produce final concise answer (tool: `tool_task_3`)
