...
Workflow: bind_registry_smoke (1.0.0)
"""
...
WORKFLOW_NAME = "bind_registry_smoke"
WORKFLOW_DESCRIPTION = "Create a workflow that extracts python code blocks from markdown and summarize output."
