...
Workflow: shell_registry_smoke3 (1.0.0)
"""
...
WORKFLOW_NAME = "shell_registry_smoke3"
WORKFLOW_DESCRIPTION = "Build a shell command workflow that requires user confirmation and allows modify or skip."
