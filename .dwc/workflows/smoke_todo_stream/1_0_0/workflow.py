...
Workflow: smoke_todo_stream (1.0.0)
"""
...
WORKFLOW_NAME = "smoke_todo_stream"
WORKFLOW_DESCRIPTION = "Return current time in ISO format"
SUBTASKS: List[Dict[str, str]] = [
  {
    "description": "Return current time in ISO format",
    "id": "return_current_time_iso_format",
...
STEP_DEFS: List[Dict[str, Any]] = [
  {
    "config": {
      "subtask_description": "Return current time in ISO format",
      "tool_name": "tool_return_current_time_iso_format"
    },
    "id": "return_current_time_iso_format",
    "retry_policy": {
...
EDGE_DEFS: List[Dict[str, Any]] = [
  {
    "condition": null,
    "source": "return_current_time_iso_format",
    "target": "synthesize"
  }
]
