...
Workflow: shell_builtin_check (1.0.0)
"""
...
WORKFLOW_NAME = "shell_builtin_check"
WORKFLOW_DESCRIPTION = "Create a workflow tool that runs shell commands only after user confirmation, and supports modify or skip based on the user message."
SUBTASKS: List[Dict[str, str]] = [
  {
    "description": "Create a workflow tool that runs shell commands only after user confirmation, and supports modify or skip based on the user message",
    "id": "task_1",
